...
export function CreateInvoiceModal({ onClose }: CreateInvoiceModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-end lg:items-center lg:justify-center">
      <div className="bg-white w-full lg:max-w-3xl lg:rounded-2xl rounded-t-3xl max-h-[90vh] overflow-y-auto pb-safe">
        {/* Header */}
        <div className="sticky top-0 bg-gradient-to-br from-blue-600 to-blue-700 lg:rounded-t-2xl px-4 lg:px-6 py-4 lg:py-5 flex items-center justify-between z-10">
          <div>
            ...
            <p className="text-blue-100 text-sm mt-0.5">Generate a professional invoice for your customer</p>
          </div>
          <button
            onClick={onClose}
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-6 space-y-4 lg:space-y-0">
            <div>
              <label className="flex items-center gap-2 text-gray-700 mb-2">
                Customer Name
                <Tooltip content="Enter the name of the customer you're creating this invoice for. You can use their business name or personal name." />
              </label>
              <input
                type="text"
                value={customerName}
            ...
            <div>
              <label className="flex items-center gap-2 text-gray-700 mb-2">
                Payment Due Date
                <Tooltip content="When should the customer pay? Set a realistic date to help you track who owes you." />
              </label>
              <input
                type="date"
                value={dueDate}
