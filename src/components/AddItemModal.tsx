...
export function AddItemModal({ onClose }: AddItemModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-end lg:items-center lg:justify-center">
      <div className="bg-white w-full lg:max-w-4xl lg:rounded-2xl rounded-t-3xl max-h-[90vh] overflow-y-auto pb-safe">
        {/* Header */}
        <div className="sticky top-0 bg-gradient-to-br from-blue-600 to-blue-700 lg:rounded-t-2xl px-4 lg:px-6 py-4 lg:py-5 flex items-center justify-between z-10">
          <div>
            <h2 className="text-white">Add New Item</h2>
            <p className="text-blue-100 text-sm mt-0.5">Add items to track in your stock</p>
          </div>
          <button
            onClick={onClose}
        ...
        {/* Form */}
        <form onSubmit={handleSubmit} className="p-4 lg:p-6 space-y-4 lg:space-y-5 pb-24 lg:pb-6">
          {/* Grid layout for desktop */}
          <div className="lg:grid lg:grid-cols-2 lg:gap-6 space-y-4 lg:space-y-0">
            <div>
              <label className="flex items-center gap-2 text-gray-700 mb-2">
                Item Name
                <Tooltip content="Enter the name of the product you want to add to your stock. E.g., Rice, Beans, Vegetable Oil" />
              </label>
              <input
                type="text"
                value={itemName}
                ...
                className="w-full px-4 py-3 lg:py-4 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
                required
              />
            </div>
            ...
            <div>
              <label className="flex items-center gap-2 text-gray-700 mb-2">
                Category
                <Tooltip content="Choose the category that best describes this item. This helps you organize your stock better." />
              </label>
              <select
                value={category}
                onChange={(e) => setCategory(e.target.value)}
                className="w-full px-4 py-3 lg:py-4 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white"
                required
              >
          ...
          <div className="grid grid-cols-2 gap-3 lg:gap-6">
            <div>
              <label className="flex items-center gap-2 text-gray-700 mb-2">
                Quantity in Stock
                <Tooltip content="How many of this item do you currently have in your store?" />
              </label>
              <input
                type="number"
                value={quantity}
            ...
            <div>
              <label className="flex items-center gap-2 text-gray-700 mb-2">
                Low Stock Alert
                <Tooltip content="We'll remind you when your stock reaches this number. Set it to a number that gives you time to restock." />
              </label>
              <input
                type="number"
                value={lowStockAlert}
          ...
          <div>
            <label className="flex items-center gap-2 text-gray-700 mb-2">
              Bulk Unit (What you buy)
              <Tooltip content="This is how you buy the item from your supplier. E.g., 50kg bag, 25L keg, carton of 12." />
            </label>
            <input
              type="text"
              value={bulkUnit}
          ...
          <div className="grid grid-cols-2 gap-3 lg:gap-6">
            <div>
              <label className="flex items-center gap-2 text-gray-700 mb-2">
                Cost Price (per {bulkUnit || 'unit'})
                <Tooltip content="How much you paid to buy one unit from your supplier. This helps calculate your profit." />
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="0"
                  className="w-full pl-10 pr-4 py-3 lg:py-4 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  min="0"
                  required
                />
              </div>
            ...
            <div>
              <label className="flex items-center gap-2 text-gray-700 mb-2">
                Selling Price (per {bulkUnit || 'unit'})
                <Tooltip content="How much you sell one unit for. Your profit is automatically calculated from cost and selling price." />
              </label>
              <div className="relative">
                <span className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400">₦</span>
                <input
